...
Getting Started
1. Download the App
You can download the latest production build from our Releases Page.

2. Prepare Your Models
To use the AI capabilities, you will need to provide your own LiteRT-compatible (.litertlm) model files.

Download your preferred quantized models (e.g., Llama 3.2, Moondream 2).

Use the "Import Model" button within the app to load the .litertlm files from your device storage.
